function [spd_data, ratio_box_mean, ratio_box_std, ratio_line_mean, ratio_line_std] = spindle_mat_plot_ratio(spd_data, list_plot, NUM_BIN, str_title, file_name)
...
dir_name = spd_data{1}.raw_file(1: strfind(spd_data{1}.raw_file, '/')-1);
if ~exist('str_title','var') || isempty(str_title); str_title = dir_name; end;
...
print_save_figure(gcf, file_name, [dir_name, '_analysis']);
